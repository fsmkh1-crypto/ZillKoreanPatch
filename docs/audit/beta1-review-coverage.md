...
- `FIXED_BUFFER`: **1629** among ledger rows; full accepted population **19380**
...
| 030 | PENDING_BASIS | 83 | 83 | `docs/audit/beta1-contextual-copyedit-030-reviewed.json` |
