...
- Valid contextual review: **14,232 (33.873%)**
  - legacy direct `full_read`: **176**
  - dense `scope_full_read`: **12,904**
  - direct `manifest_edit`: **1,152**
...
- `FIXED_BUFFER`: **5815** among ledger rows; full accepted population **19380**
