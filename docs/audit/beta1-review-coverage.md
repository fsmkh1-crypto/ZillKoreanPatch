...
- Valid contextual review: **31,031 (73.855%)**
  - legacy direct `full_read`: **176**
  - dense `scope_full_read`: **29,065**
  - direct `manifest_edit`: **1,790**
  - propagated: **0** (not yet credited)
- `CONTEXT_STALE`: **0**
- `LAYOUT_RECHECK`: **0** (orthogonal; does not erase language coverage)
- `UNREVIEWED` for contextual purposes: **10,985**
- Approved registered manifest records (historical, non-deduplicated): **1,796**
...
- `FIXED_BUFFER`: **15626** among ledger rows; full accepted population **19380**
...
- Duplicate groups: **2,661**
- IDs inside duplicate groups: **8,944**
