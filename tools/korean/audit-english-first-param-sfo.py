...
for pattern, label in (
    ...
    (r'^version\s*=\s*0x00000101$', "PSF version"),
    (r'^expected_absent\s*=\s*\["MEMSIZE"\]$', "MEMSIZE absence guard"),
    (r'^key\s*=\s*"MEMSIZE"$', "MEMSIZE append key"),
    (r'^format\s*=\s*0x0404$', "MEMSIZE format"),
