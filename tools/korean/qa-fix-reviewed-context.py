...
FIXES = {
    ...
    "1370479": (
        "…아, 내친김에 하나 더. 미안하지만 가는 길에 술집에 들러서 이걸 펠름에게 전해 줘.<end>",
        "…아, 내친김에 하나 더. 미안하지만 가는 길에 술집에 들러 이걸 페름에게 전해 줘.<end>",
    ),
    "2560006": (
    ...
    # Exact duplicate experiment result narration; use the neutral subject-marker form consistently.
    "2560041": (
        "<value:$28>은 기절한 페티를 여관까지 업고 돌아왔다. <value:$28>의 STR이 1 올랐다. 유리스는 고도의 실험에 성공했다. 유리스의 INT가 1 올랐다. 유리스의 MIN이 1 올랐다.<end>",
        "<value:$28>는 기절한 페티를 업고 여관까지 돌아왔다. <value:$28>의 STR이 1 올랐다. 유리스는 고도의 실험에 성공했다. 유리스의 INT가 1 올랐다. 유리스의 MIN이 1 올랐다.<end>",
    ),
    # Same Zenetes battle scene duplicated across Angildan volumes.
    "590071": (
        "…<value:$28>! 너도 앙길단 영감 편이냐! 쳇, 인물은 인물을 부르는군. 이거 조금 불리하겠어. 뭐, 됐다. 어떻게든 운명의 여신을 돌아보게 하는 데는 성공한 모양이니.<end>",
        "…<value:$28>! 너도 앙길단 영감 쪽이냐! 쳇, 인물은 인물을 부르는 법이군. 이거 조금 불리하겠어. 뭐, 됐어. 어떻게든 운명의 여신을 돌아보게 하는 데는 성공한 모양이니까.<end>",
    ),
    # Same Dragon King declaration; normalize both copies to one natural rendering.
    "1120020": (
        " 수많은 세월이 지나도 사라지지 않는 원한에서 태어난 허무의 아이여, 이곳은 네 세계가 아니다….<end>",
        "오랜 세월이 흘러도 사라지지 않는 원념에서 태어난 허무의 아이여, 이곳은 네 세계가 아니다….<end>",
    ),
    "1400286": (
        "오랜 세월이 지나도 사라지지 않은 원념에서 태어난 허무의 아이여, 여기는 네 세계가 아니다….<end>",
        "오랜 세월이 흘러도 사라지지 않는 원념에서 태어난 허무의 아이여, 이곳은 네 세계가 아니다….<end>",
    ),
    # Same Ea farewell scene; keep the less emphatic, natural Korean phrasing.
    "1400400": (
        "………………. 가거라. 이대로라면 내가 그대를 붙잡아 버릴 것 같구나.<end>",
        "………………. 가거라. 이대로라면 내가 그대를 붙잡아 둘 것 같구나.<end>",
    ),
}
